...
\begin{document}
  ...
  We will also take a look at Labelled Transition Systems, since they are the low level counterpart to ACP and process calculi in general. The report is largely based on Modelling and Analysis of Communicating Systems by Jan Friso Groote and Michel Reniers. \cite{mcrl2book}
