...
\lstdefinelanguage{mCRL2}{
  ...
  comment=[l]{\%},
  commentstyle=\color[rgb]{0.6,0.6,0.6}\ttfamily\itshape,
}
...
\definecolor{lightWhite}{RGB}{249,249,249}
...
\begin{document}
  ...
  \begin{frame}{Bisimulation}
    Bisumularity of two coffee machines \\[24pt]
    \begin{tabular}{cc}
      \begin{minipage}{.5\linewidth}
        \centering
        \begin{tikzpicture}[font=\sffamily\tiny]
          \node[vertex] (P1) at (1.6, 3) {$P1$};
          \node[vertex] (P2) at (0, 1.7) {$P2$};
          \node[vertex] (P3) at (3.2, 1.7) {$P3$};
          \node[vertex] (P4) at (0, 0) {$P4$};
          \node[vertex] (P5) at (3.2, 0) {$P5$};

          \path[->] (P1) edge  node[midway, fill=lightWhite] {$coin$} (P2);
          \path[->] (P1) edge  node[midway, fill=lightWhite] {$coin$} (P3);
          \path[->] (P2) edge  node[midway, fill=lightWhite] {$get-tea$} (P4);
          \path[->] (P3) edge  node[midway, fill=lightWhite] {$get-coffee$} (P5);
          \path[->] (P4) edge [bend right=25] node[midway, fill=lightWhite] {$tea$} (P1);
          \path[->] (P5) edge [bend left=25]  node[midway, fill=lightWhite] {$coffee$} (P1);
        \end{tikzpicture}
      \end{minipage}
      \begin{minipage}{.5\linewidth}
        \centering
        \begin{tikzpicture}[font=\sffamily\tiny]
          ...
          \node[vertex] (Q2) at (1.6, 1.7) {$Q2$};
          \node[vertex] (Q3) at (3.2, 0) {$Q3$};
          \node[vertex] (Q4) at (0, 0) {$Q4$};;

          \path[->] (Q1) edge  node[midway, fill=lightWhite] {$coin$} (Q2);
          \path[->] (Q2) edge  node[midway, anchor=center, fill=lightWhite] {$get-coffee$} (Q3);
          \path[->] (Q2) edge  node[midway, anchor=center, fill=lightWhite] {$get-tea$} (Q4);
          \path[->] (Q3) edge  [bend right=40] node[midway, anchor=center, fill=lightWhite] {$coffee$} (Q1);
          \path[->] (Q4) edge   [bend left=40] node[midway, fill=lightWhite] {$tea$} (Q1);
        \end{tikzpicture}
      \end{minipage}
    \end{tabular}
  \end{frame}
