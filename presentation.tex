    ...
    \resizebox{\textwidth}{!}{
      \begin{tabular}{cc}
          \begin{tikzpicture}[font=\sffamily\tiny]
            ...
            \path[edge] (P1) edge node[fill=bg] {$\mathit{insert\ coin}$} (P2);
            \path[edge] (P2) edge node[fill=bg] {$\mathit{choose\ coffee}$} (P3);
            \path[edge] (P2) edge node[fill=bg] {$\mathit{choose\ tea}$} (P4);
            \path[edge] (P3) edge [bend right=40] node[fill=bg] {$\mathit{pour\ coffee}$} (P1);
            \path[edge] (P4) edge [bend left=40] node[fill=bg] {$\mathit{pour\ tea}$} (P1);
          \end{tikzpicture}
          &
          \begin{tikzpicture}[font=\sffamily\tiny]
            ...
            \path[edge] (Q1) edge node[fill=bg] {$\mathit{insert\ coin}$} (Q2);
            \path[edge] (Q1) edge node[fill=bg] {$\mathit{insert\ coin}$} (Q3);
            \path[edge] (Q2) edge node[label=left:$\mathit{choose\ tea}$] {} (Q4);
            \path[edge] (Q3) edge node[label=right:$\mathit{choose\ coffee}$] {} (Q5);
            \path[edge] (Q4) edge [bend right=25] node[fill=bg] {$\mathit{pour\ tea}$} (Q1);
            \path[edge] (Q5) edge [bend left=25]  node[xshift=7.5pt, yshift=-10pt, fill=bg] {$\mathit{pour\ coffee}$} (Q1);
          \end{tikzpicture}
      \end{tabular}
    }
  \end{frame}
