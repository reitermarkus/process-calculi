    ...
    \begin{tabular}{cc}
      \begin{minipage}{.5\linewidth}
        ...
        \begin{tikzpicture}[font=\sffamily\tiny]
          ...
          \path[edge] (P1) edge node[fill=bg] {$insert\ coin$} (P3);
          \path[edge] (P2) edge node[label=left:$choose\ tea$] {} (P4);
          \path[edge] (P3) edge node[label=right:$choose\ coffee$] {} (P5);
          \path[edge] (P4) edge [bend right=25] node[fill=bg] {$pour\ tea$} (P1);
          \path[edge] (P5) edge [bend left=25]  node[xshift=7.5pt, yshift=-10pt, fill=bg] {$pour\ coffee$} (P1);
        \end{tikzpicture}
      \end{minipage}
      \begin{minipage}{.5\linewidth}
        \centering
        \begin{tikzpicture}[font=\sffamily\tiny]
          ...
          \path[edge] (Q2) edge node[fill=bg] {$choose\ coffee$} (Q3);
          \path[edge] (Q2) edge node[fill=bg] {$choose\ tea$} (Q4);
          \path[edge] (Q3) edge [bend right=40] node[fill=bg] {$pour\ coffee$} (Q1);
          \path[edge] (Q4) edge [bend left=40] node[fill=bg] {$pour\ tea$} (Q1);
        \end{tikzpicture}
      \end{minipage}
    \end{tabular}
  \end{frame}
